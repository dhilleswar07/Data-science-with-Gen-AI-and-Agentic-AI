...
face_classifier = cv2.CascadeClassifier(r"E:\DATASCIENCE WITH GEN AI & AGENTIC AI\VSCODE\HaarCascade\haarcascade_frontalface_default.xml")
eye_classifier = cv2.CascadeClassifier(r"E:\DATASCIENCE WITH GEN AI & AGENTIC AI\VSCODE\HaarCascade\haarcascade_eye.xml")
#image = cv2.imread(r"D:\NIT\1. NIT_Batches\10. WORKSHOP\2024 - WORKSHOP\7. Exploring Generative AI through computer vision\myimage.jpg")
...
img = cv2.imread(r"E:\DATASCIENCE WITH GEN AI & AGENTIC AI\VSCODE\CNN_Happy_OR_Sad\Training\Happy\web3-happy-people-outside-smile-sun-nature-eduardo-dutra-620857-unsplash.jpg")
