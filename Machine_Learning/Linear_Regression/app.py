...
model = pickle.load(open(r"E:\DATASCIENCE WITH GEN AI & AGENTIC AI\VSCODE\linear_regression_model.pkl", 'rb'))

st.title("Salary Prediction App Created by Dhilleswar")
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Dhilleswar")