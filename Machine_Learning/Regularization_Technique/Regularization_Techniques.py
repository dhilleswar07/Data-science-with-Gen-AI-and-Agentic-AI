...
data = pd.read_csv("E:\DATASCIENCE WITH GEN AI & AGENTIC AI\VSCODE\Machine_Learning\Regularization_Technique\car-mpg.csv")
data.head()

# Drop unnecessary column
data = data.drop(['car_name'], axis=1)

# Convert origin codes to names
